...
export default function ApparelPage() {
  return (
    <div className="section">
      ...
      <p style={{ color: 'var(--muted)', fontSize: '0.88rem', lineHeight: 1.7, maxWidth: '600px', marginBottom: '3rem' }}>
      ...
      <div className="grid-4">
        {APPAREL.map(a => (
          <div key={a.id} style={{ background: '#0a0a0a', padding: '2rem', textAlign: 'center' }}>
            ...
            <div style={{ fontSize: '0.75rem', color: 'var(--muted)', lineHeight: 1.5 }}>{a.description}</div>
          </div>
        ))}
      </div>

      <div style={{ marginTop: '2.5rem', padding: '1.5rem 2rem', background: 'rgba(232,160,0,0.06)', borderLeft: '3px solid #E8A000', color: 'var(--muted)', fontSize: '0.88rem', lineHeight: 1.7 }}>

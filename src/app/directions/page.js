  ...
  return (
    <div className="section">
      ...
      <div style={{ background: '#111', border: '1px solid rgba(232,160,0,0.2)', padding: '2.5rem', marginBottom: '3rem' }}>
        ...
        <p style={{ color: '#C41E3A', fontSize: '0.9rem', lineHeight: 1.7, marginBottom: '1.5rem' }}>
      ...
      <div className="grid-3" style={{ marginBottom: '3rem' }}>
        {HOTELS.map(h => (
          <div key={h.name} className="card">
            ...
            <p style={{ color: '#C41E3A', fontSize: '0.85rem', lineHeight: 1.7, marginBottom: '0.5rem' }}>{h.addr}</p>
            ...
            <p style={{ color: 'rgba(196,30,58,0.75)', fontSize: '0.8rem', marginBottom: '1.2rem' }}>{h.notes}</p>
